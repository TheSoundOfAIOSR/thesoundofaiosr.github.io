...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.082601608a8833542d4390685d5d6a2b210adbc611b633ceb85e2073741de8e4.js',function(){input.required=false;search();});}
